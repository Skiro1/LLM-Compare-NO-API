...
Все провайдеры используют формат, совместимый с OpenAI API. Подробности по эндпоинтам, параметрам и стримингу — в официальной документации каждого провайдера.
