const LMS_PROVIDERS = {
            ...
            anthropic: {
                ...
                hint:        'Получите ключ на <a href="https://console.anthropic.com" target="_blank" class="text-blue-500 hover:underline">console.anthropic.com</a>.<br><span style="color:#a16207;">⚠️ Требуется запуск прокси: <code>node proxy-server.js</code></span>',
