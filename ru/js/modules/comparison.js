            ...
            container.innerHTML = answersWithContent.map(m => {
                ...
                <div class="comparison-card">
                    ...
                    <div class="comparison-card-footer">
                        ...
                        <button class="btn btn-copy btn-sm btn-icon" data-icon-size="w-3.5 h-3.5" title="Скопировать ответ модели" aria-label="Скопировать ответ модели" onclick="copyModelAnswer('${m.id}', 'comp-copy-${m.id}')" id="comp-copy-${m.id}">
